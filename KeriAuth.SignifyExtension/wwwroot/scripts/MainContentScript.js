//// KeriAuth.SignifyExtension - IntegratedScript.js
...
const sendWalletRequest = (walletRequest, walletRequestReturnFunction) => {
    ...
    if (!existingOverlay && walletRequest.iframeMode) {
        ...
        closeBtn.addEventListener("click", window.closeOverlay);
...
function hashCode(str) {
    return Array.from(str)
        .reduce((s, c) => Math.imul(31, s) + c.charCodeAt(0) | 0, 0).toString();
}
(() => {
...
export {};
//# sourceMappingURL=MainContentScript.js.map