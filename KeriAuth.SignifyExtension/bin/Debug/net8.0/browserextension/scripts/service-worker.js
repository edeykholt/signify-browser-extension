...
async function SetWalletRequest(result, message) {
    let key = message.contentHash;
    var listOfWalletRequests = [];
    if (result != undefined) {
...
export {};
//# sourceMappingURL=service-worker.js.map/* Manifest version: hIGbXHbc */
